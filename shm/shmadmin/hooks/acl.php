...
class Acl {
	...
	public function auth(){
		...
		if (!$this->CI->session->userdata('gid')) {
			//检测cookie
			if ($this->CI->input->cookie('_remember') and $this->CI->input->cookie('_m') ) {
	...
	public function _cookie_login()
	{
		...
		if ( md5(HMACPWD.$info['uname'].get_ip()) == $this->CI->input->cookie('_remember') ) {
...
/* End of file acl.php */
/* Location: .//home/http/shmms/adminer/hooks/acl.php */
