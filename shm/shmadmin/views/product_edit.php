...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span4' id="subtitle" name="subtitle" value="<?php echo set_value("subtitle", $it['subtitle']) ?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span4' id="decorate" name="decorate" value="<?php echo set_value("decorate", $it['decorate']) ?>">
            </div>
        </div>
