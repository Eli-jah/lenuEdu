            ...
            <?php foreach ($list as $v){ ?>
                <tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
                    ...
                    <td style="text-align:right;">
                        <div class="btn-group">
                            <a class='btn btn-small' href=" <?php echo site_url($this->router->class . '/edit/' . $v['id']) ?> " title="查看">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a class='btn btn-danger btn-small btn-del' href="#" data-id="<?php echo $v['id'] ?>" title=" <?php echo lang('del') ?>">
