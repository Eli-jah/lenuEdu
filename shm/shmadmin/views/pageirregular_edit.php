...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span7' name="title" id="title"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span7' name="tagtitle" id="tagtitle"
                       value="<?php echo set_value('tagtitle', $it['tagtitle']); ?>">
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span7' name="entitle" id="entitle"
                       value="<?php echo set_value('entitle', $it['entitle']); ?>">
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class='span7' name="url" id="url"
                       value="<?php echo set_value('url', $it['url']); ?>">
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <span class="help-inline"></span>
                <span style="color:#F00">内容中的图片可以选择是否要下载到本网站中！</span>
            </div>
        </div>
