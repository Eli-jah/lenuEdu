        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <ul class="nav pull-right">
                    ...
                    <?php endif ?>
                    <li>
                        <a href="<?php echo GLOBAL_URL ?>" target="_blank">
                            <span class="fa fa-globe"></span> <?php echo lang('nav_see_site'); ?>
                        </a>
                    </li>

                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user"></i> <?php echo $this->session->userdata('nickname'); ?>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu" style="width: 99px; min-width: 114px;">
                            <li>
                                <a href="<?php echo site_url('manager/edit/') ?>/<?php echo $this->session->userdata('mid') ?>">
                                    <i class="fa fa-user"></i> 设置账户
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('manager/passwd') ?>"> <i class="fa fa-key"></i> 重设密码</a>
                            </li>
                        </ul>
                    </li>
