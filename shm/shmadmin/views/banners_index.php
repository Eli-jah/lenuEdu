<div class="btn-group">
    <a href="<?php echo site_urlc('banners/create') ?>" class='btn btn-primary'>
                ...
                <tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a class='btn  btn-danger btn-small' href=" <?php echo site_urlc($this->router->class . '/edit/' . $v['id']) ?> " title="<?php echo lang('edit') ?>">
                                <i class="fa fa-pencil"></i> <?php // echo lang('edit') ?>
                            </a>
                            <a class='btn btn-small btn-del' data-id="<?php echo $v['id'] ?>" href="#" title="<?php echo lang('del') ?>">
