...
<div class="boxed">
    ...
    <h3>
        添加 <span class="badge badge-success pull-right"><?php echo $title; ?></span>
    </h3>
    ...
    <div class="boxed-inner seamless">
        ...
        <?php if ($mtype_id == 2) { ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="email" value="example@example.com" id="email">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="telphone" value="0123-12345678" id="telphone">
                </div>
            </div>
        <?php } ?>
