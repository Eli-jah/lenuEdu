...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="title" name="title" value="<?php echo set_value('title') ?>" placeholder="栏目标题"
                       required>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="identify" name="identify" value="<?php echo set_value('identify') ?>"
                       placeholder="columns identify" required>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="temp_index" name="temp_index" value="<?php echo set_value('temp_index') ?>"
                       placeholder="栏目页面">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="temp_show" name="temp_show" value="<?php echo set_value('temp_show') ?>"
                       placeholder="栏目内容页面">
