...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="identify" name="identify"
                       value="<?php echo set_value('identify', $it['identify']) ?>">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="temp_index" name="temp_index"
                       value="<?php echo set_value('temp_index', $it['temp_index']) ?>" placeholder="栏目页面">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="temp_show" name="temp_show"
                       value="<?php echo set_value('temp_show', $it['temp_show']) ?>" placeholder="栏目内容页面">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="title_seo" name="title_seo"
                               value="<?php echo set_value('title_seo', $it['title_seo']) ?>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="control-group">
