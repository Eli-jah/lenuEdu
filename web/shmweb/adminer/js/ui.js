        ...
        var ui = {
            ...
            btn_select_all: function (parent_node) {
                ...
                $(parent_node + '#select-all').on('click', function (e) {
                    e.preventDefault();
                    $(parent_node + '.select-list input[type="checkbox"].select-it').each(function (i, item) {
                        item.checked = true;
                ...
                $(parent_node + '#unselect-all').on('click', function (e) {
                    e.preventDefault();
                    $(parent_node + '.select-list  input[type="checkbox"].select-it.checked').each(function (i, item) {
                        item.checked = false;
                        $(item).removeClass('checked');
                    });
                        ...
                        if (data.status == 1) {
                            ...
                            if (audit.audit == 1) {
                                ...
                                $(audit.its).each(function (i, item) {
                                    $(item).find('.btn-ajax-audit').addClass('btn-primary').attr({
                                        'data-audit': '0',
                                        'title': '取消审核'
                                    });
                                ...
                                msg.type = 'notice';
                                $(audit.its).each(function (i, item) {
                                    $(item).find('.btn-ajax-audit').removeClass('btn-primary').attr({
                                        'data-audit': '1',
                                        'title': '审核'
                                    });
